...
const SetVarMainTemplatePlugin = require("webpack/lib/SetVarMainTemplatePlugin");
	...
	apply(compiler) {
		compiler.plugin("this-compilation", (compilation) => {
			if(this.exportProperty) {
				var ExportPropertyMainTemplatePlugin = require("webpack/lib/ExportPropertyMainTemplatePlugin");
